...
import {PositionValue} from "v3-periphery/contracts/libraries/PositionValue.sol";
import {INonfungiblePositionManager} from "v3-periphery/contracts/interfaces/INonfungiblePositionManager.sol";
import {SafeCast} from "openzeppelin-contracts/contracts/utils/SafeCast.sol";
...
contract V3PositionHelper {
    ...
    function getPosition(
        ...
        {
            (uint256 amount0, uint256 amount1) = PositionValue._fees(
                positionManager,
                PositionValue.FeeParams({
